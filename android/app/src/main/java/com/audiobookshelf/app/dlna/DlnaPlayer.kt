...
class DlnaPlayer(
    ...
    override fun onPlaybackStateChanged(isPlaying: Boolean) {
        ...
        setPlayerStateAndNotifyIfChanged(
            ...
            if (isPlaying) STATE_READY else STATE_READY
        )
    }
    ...
    override fun getCurrentPosition(): Long {
        Log.d(tag, "getCurrentPosition called: returning ${lastReportedPositionMs}ms")
    ...
    override fun setVolume(audioVolume: Float) {
        dlnaManager.setVolume((audioVolume * 100).toInt())
    }

    override fun getVolume(): Float {
        var volume = 0f
        dlnaManager.getVolume { volume = it / 100f }
        return volume
    }
    ...
    override fun getDeviceVolume(): Int {
        var volume = 0
        dlnaManager.getVolume { volume = it }
        return volume
    }
    ...
    override fun increaseDeviceVolume() {
        dlnaManager.getVolume { currentVolume ->
            dlnaManager.setVolume((currentVolume + 5).coerceAtMost(100))
        }
    }

    override fun decreaseDeviceVolume() {
        dlnaManager.getVolume { currentVolume ->
            dlnaManager.setVolume((currentVolume - 5).coerceAtLeast(0))
        }
    }

    override fun setDeviceMuted(muted: Boolean) {
        dlnaManager.setVolume(if (muted) 0 else 50)
    }
}
